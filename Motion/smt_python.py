...
import subprocess
import time
from motion_lock import oracle
...
s.add(key1_1 > 0 , key1_1 <  100)
s.add(key2_1 > 0 , key2_1 <  100)
s.add(key3_1 > 0 , key3_1 <  100)
s.add(key4_1 > 0 , key4_1 <  100)
s.add(key1_1 > 0 , key1_2 <  100)
s.add(key2_2 > 0 , key2_2 <  100)
s.add(key3_2 > 0 , key3_2 <  100)
s.add(key4_2 > 0 , key4_2 <  100)
s.add(key1_2 > 0 , key1_2 <  100)
