...
s.add(l2n1v1_1 > 6, l2n1v1_1 < 12)
s.add(l2n1v2_1 > 6, l2n1v2_1 < 12)
s.add(l2n2v1_1 > 3, l2n2v1_1 < 9)
s.add(l2n2v2_1 > 3, l2n2v2_1 < 9)
s.add(l2n3v1_1 > -6, l2n3v1_1 < 0)
s.add(l2n3v2_1 > -6, l2n3v2_1 < 0)
s.add(l2n4v1_1 > -6, l2n4v1_1 < 0)
s.add(l2n4v2_1 > -6, l2n4v2_1 < 0)
...
while s.check(out1 != out2) == sat:
	...
	s.add(NN(inp1,inp2,inp3,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1) == out_tup)
	s.add(NN(inp1,inp2,inp3,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1) == out_tup)
