...
ov1_1,ov1_2,ov1_3,ov1_4,ov1_5,ov1_6,ov1_7,ov1_8 = Ints('ov1_1 ov1_2 ov1_3 ov1_4 ov1_5 ov1_6 ov1_7 ov1_8')
ov2_1,ov2_2,ov2_3,ov2_4,ov2_5,ov2_6,ov2_7,ov2_8 = Ints('ov2_1 ov2_2 ov2_3 ov2_4 ov2_5 ov2_6 ov2_7 ov2_8')

tuple = Datatype('tuple')
tuple.declare('tuple',('1',IntSort()),('2',IntSort()),('3',IntSort()),('4',IntSort()),('5',IntSort()),('6',IntSort()),('7',IntSort()),('8',IntSort()))
tuple = tuple.create()
out1 = tuple.tuple(ov1_1,ov1_2,ov1_3,ov1_4,ov1_5,ov1_6,ov1_7,ov1_8)
out2 = tuple.tuple(ov2_1,ov2_2,ov2_3,ov2_4,ov2_5,ov2_6,ov2_7,ov2_8)

def NN(in1,in2,in3,l1n1_1,l1n1_2,l1n1_3,l1n1_4,l1n2_1,l1n2_2,l1n2_3,l1n2_4,l1n3_1,l1n3_2,l1n3_3,l1n3_4,l2n1_1,l2n1_2,l2n1_3,l2n1_4,l2n2_1,l2n2_2,l2n2_3,l2n2_4,l2n3_1,l2n3_2,l2n3_3,l2n3_4,l2n4_1,l2n4_2,l2n4_3,l2n4_4):
	...
	out = tuple.tuple(l2out_1,l2out_2,l2out_3,l2out_4,l3out_1,l3out_2,l3out_3,l3out_4)
...
s.add(l2n4v1_1 > 2, l2n4v1_1 < 4)
s.add(l2n4v2_1 > 2, l2n4v2_1 < 4)

s.add(NN(in1,in2,in3,l1n1v1_1,l1n1v1_2,l1n1v1_3,l1n1v1_4,l1n2v1_1,l1n2v1_2,l1n2v1_3,l1n2v1_4,l1n3v1_1,l1n3v1_2,l1n3v1_3,l1n3v1_4,l2n1v1_1,l2n1v1_2,l2n1v1_3,l2n1v1_4,l2n2v1_1,l2n2v1_2,l2n2v1_3,l2n2v1_4,l2n3v1_1,l2n3v1_2,l2n3v1_3,l2n3v1_4,l2n4v1_1,l2n4v1_2,l2n4v1_3,l2n4v1_4) == out1)
s.add(NN(in1,in2,in3,l1n1v2_1,l1n1v2_2,l1n1v2_3,l1n1v2_4,l1n2v2_1,l1n2v2_2,l1n2v2_3,l1n2v2_4,l1n3v2_1,l1n3v2_2,l1n3v2_3,l1n3v2_4,l2n1v2_1,l2n1v2_2,l2n1v2_3,l2n1v2_4,l2n2v2_1,l2n2v2_2,l2n2v2_3,l2n2v2_4,l2n3v2_1,l2n3v2_2,l2n3v2_3,l2n3v2_4,l2n4v2_1,l2n4v2_2,l2n4v2_3,l2n4v2_4) == out2)
...
while s.check(out1 != out2) == sat:
	...
	out_tup = tuple.tuple(out[0],out[1],out[2],out[3],out[4],out[5],out[6],out[7])

	s.add(NN(inp1,inp2,inp3,l1n1v1_1,l1n1v1_2,l1n1v1_3,l1n1v1_4,l1n2v1_1,l1n2v1_2,l1n2v1_3,l1n2v1_4,l1n3v1_1,l1n3v1_2,l1n3v1_3,l1n3v1_4,l2n1v1_1,l2n1v1_2,l2n1v1_3,l2n1v1_4,l2n2v1_1,l2n2v1_2,l2n2v1_3,l2n2v1_4,l2n3v1_1,l2n3v1_2,l2n3v1_3,l2n3v1_4,l2n4v1_1,l2n4v1_2,l2n4v1_3,l2n4v1_4) == out_tup)
	s.add(NN(inp1,inp2,inp3,l1n1v2_1,l1n1v2_2,l1n1v2_3,l1n1v2_4,l1n2v2_1,l1n2v2_2,l1n2v2_3,l1n2v2_4,l1n3v2_1,l1n3v2_2,l1n3v2_3,l1n3v2_4,l2n1v2_1,l2n1v2_2,l2n1v2_3,l2n1v2_4,l2n2v2_1,l2n2v2_2,l2n2v2_3,l2n2v2_4,l2n3v2_1,l2n3v2_2,l2n3v2_3,l2n3v2_4,l2n4v2_1,l2n4v2_2,l2n4v2_3,l2n4v2_4) == out_tup)
