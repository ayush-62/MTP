...
l1n3v1_1,l1n3v1_2,l1n3v1_3 = Ints('l1n3v1_1 l1n3v1_2 l1n3v1_3')
l1n1v2_1,l1n1v2_2,l1n1v2_3 = Ints('l1n1v2_1 l1n1v2_2 l1n1v2_3')
l1n2v2_1,l1n2v2_2,l1n2v2_3 = Ints('l1n2v2_1 l1n2v2_2 l1n2v2_3')
l1n3v2_1,l1n3v2_2,l1n3v2_3 = Ints('l1n3v2_1 l1n3v2_2 l1n3v2_3')
l2n1v1_1,l2n1v1_2,l2n1v1_3 = Ints('l2n1v1_1 l2n1v1_2 l2n1v1_3')
l2n2v1_1,l2n2v1_2,l2n2v1_3 = Ints('l2n2v1_1 l2n2v1_2 l2n2v1_3')
l2n3v1_1,l2n3v1_2,l2n3v1_3 = Ints('l2n3v1_1 l2n3v1_2 l2n3v1_3')
l2n1v2_1,l2n1v2_2,l2n1v2_3 = Ints('l2n1v2_1 l2n1v2_2 l2n1v2_3')
l2n2v2_1,l2n2v2_2,l2n2v2_3 = Ints('l2n2v2_1 l2n2v2_2 l2n2v2_3')
l2n3v2_1,l2n3v2_2,l2n3v2_3 = Ints('l2n3v2_1 l2n3v2_2 l2n3v2_3')
...
def NN(in1,in2,in3,l3n1_1,l3n2_1,l3n3_1):
	...
	l3out_1,l3out_2,l3out_3 = Ints('l3out_1 l3out_2 l3out_3')
	l3out_1 = (l2out_1 * (-3)) + (l2out_2 * 6) + (l2out_3 * 3) 
	l3out_1 = If(l3out_1 < 0, 0, l3out_1)
	l3out_2 = (l2out_1 * 4) + (l2out_2 * (-7)) + (l2out_3 * (-3)) 
	l3out_2 = If(l3out_2 < 0, 0, l3out_2)
	l3out_3 = (l2out_1 * 5) + (l2out_2 * 1) + (l2out_3 * (-3)) 
	l3out_3 = If(l3out_3 < 0, 0, l3out_3)
	
	l4out_1 = Int('l4out_1')
	l4out_1 = (l3out_1 * l3n1_1) + (l3out_2 * l3n2_1) + (l3out_3 * l3n3_1)
...
s.add(NN(in1,in2,in3,l3n1v1_1,l3n2v1_1,l3n3v1_1) == out1)
s.add(NN(in1,in2,in3,l3n1v2_1,l3n2v2_1,l3n3v2_1) == out2)
...
while s.check(out1 != out2) == sat:
	...
	s.add(NN(inp1,inp2,inp3,l3n1v1_1,l3n2v1_1,l3n3v1_1) == out_tup)
	s.add(NN(inp1,inp2,inp3,l3n1v2_1,l3n2v2_1,l3n3v2_1) == out_tup)
