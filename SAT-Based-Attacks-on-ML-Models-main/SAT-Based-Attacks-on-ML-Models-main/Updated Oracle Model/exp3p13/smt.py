...
s.add(neuralNetwork(input, l1n1v1, l1n2v1, l2n1v1, l2n2v1, l2n3v1)[0] == output1[0], neuralNetwork(input, l1n1v1, l1n2v1, l2n1v1, l2n2v1, l2n3v1)[1] == output1[1], neuralNetwork(input, l1n1v1, l1n2v1, l2n1v1, l2n2v1, l2n3v1)[2] == output1[2], neuralNetwork(input, l1n1v1, l1n2v1, l2n1v1, l2n2v1, l2n3v1)[3] == output1[3])
s.add(neuralNetwork(input, l1n1v2, l1n2v2, l2n1v2, l2n2v2, l2n3v2)[0] == output2[0], neuralNetwork(input, l1n1v2, l1n2v2, l2n1v2, l2n2v2, l2n3v2)[1] == output2[1], neuralNetwork(input, l1n1v2, l1n2v2, l2n1v2, l2n2v2, l2n3v2)[2] == output2[2], neuralNetwork(input, l1n1v2, l1n2v2, l2n1v2, l2n2v2, l2n3v2)[3] == output2[3])
...
while s.check(output1[0] != output2[0], output1[1] != output2[1], output1[2] != output2[2]) == sat:
    ...
    s.add(neuralNetwork(inp, l1n1v1, l1n2v1, l2n1v1, l2n2v1, l2n3v1)[0] == out[0], neuralNetwork(inp, l1n1v1, l1n2v1, l2n1v1, l2n2v1, l2n3v1)[1] == out[1], neuralNetwork(inp, l1n1v1, l1n2v1, l2n1v1, l2n2v1, l2n3v1)[2] == out[2], neuralNetwork(inp, l1n1v1, l1n2v1, l2n1v1, l2n2v1, l2n3v1)[3] == out[3])
    s.add(neuralNetwork(inp, l1n1v2, l1n2v2, l2n1v2, l2n2v2, l2n3v2)[0] == out[0], neuralNetwork(inp, l1n1v2, l1n2v2, l2n1v2, l2n2v2, l2n3v2)[1] == out[1], neuralNetwork(inp, l1n1v2, l1n2v2, l2n1v2, l2n2v2, l2n3v2)[2] == out[2], neuralNetwork(inp, l1n1v2, l1n2v2, l2n1v2, l2n2v2, l2n3v2)[3] == out[3])
