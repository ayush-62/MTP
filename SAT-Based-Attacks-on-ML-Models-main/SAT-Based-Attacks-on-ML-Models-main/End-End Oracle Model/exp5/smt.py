...
def print_details(model):
    ...
    print("  BiasV1: [" + str(model[bias1].as_long()) + " ]")
    ...
    print("  BiasV2: [" + str(model[bias2].as_long()) + " ]")
...
def neuralNetwork(input, l1n1, l1n2, l2n1, l2n2, bias):
    ...
    hiddenValues[0] = (input[0] * l1n1[0]) + (input[1] * l1n2[0]) + bias
...
s.add(simplify(neuralNetwork(input, l1n1v1, l1n2v1, l2n1v1, l2n2v1, bias1)[0] == output1[0]))
s.add(simplify(neuralNetwork(input, l1n1v2, l1n2v2, l2n1v2, l2n2v2, bias2)[0] == output2[0]))
...
while s.check(output1[0] != output2[0]) == sat:
    ...
    s.add(simplify(neuralNetwork(inp, l1n1v1, l1n2v1, l2n1v1, l2n2v1, bias1)[0] == out))
    s.add(simplify(neuralNetwork(inp, l1n1v2, l1n2v2, l2n1v2, l2n2v2, bias2)[0] == out))
