...
def print_details(model):
    ...
    print("  L1Wv1: [ [" + str(model[l1n1v1[0]].as_long()) + "], [" + str(model[l1n2v1[0]].as_long()) + ", " + str(model[l1n2v1[1]].as_long()) + "] ]")
    ...
    print()
    print("  L1Wv2: [ [" + str(model[l1n1v2[0]].as_long()) + "], [" + str(model[l1n2v2[0]].as_long()) + ", " + str(model[l1n2v2[1]].as_long()) + "] ]")
...
def neuralNetwork(input, l1n1, l1n2, l2n1, l2n2, bias):
    ...
    hiddenValues[1] = (input[0] * 2) + (input[1] * l1n2[1]) + bias[1]
