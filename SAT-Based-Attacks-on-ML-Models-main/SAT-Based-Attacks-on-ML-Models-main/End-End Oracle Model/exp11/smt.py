...
def print_details(model):
    ...
    print("  L2Wv1: [ [" + str(model[l2n2v1[0]].as_long()) + "] ]")
    ...
    print("  L2Wv2: [ [" + str(model[l2n2v2[0]].as_long()) + "] ]")
...
def neuralNetwork(input, l1n1, l1n2, l2n2, bias):
    ...
    outputValues[0] = (hiddenValues[0] * 7) + (hiddenValues[1] * l2n2[0])

    return outputValues

s = Tactic('smt').solver()

s.add(simplify(neuralNetwork(input, l1n1v1, l1n2v1, l2n2v1, biasv1)[0] == output1[0]))
s.add(simplify(neuralNetwork(input, l1n1v2, l1n2v2, l2n2v2, biasv2)[0] == output2[0]))
...
while s.check(output1[0] != output2[0]) == sat:
    ...
    s.add(simplify(neuralNetwork(inp, l1n1v1, l1n2v1, l2n2v1, biasv1)[0] == out))
    s.add(simplify(neuralNetwork(inp, l1n1v2, l1n2v2, l2n2v2, biasv2)[0] == out))
