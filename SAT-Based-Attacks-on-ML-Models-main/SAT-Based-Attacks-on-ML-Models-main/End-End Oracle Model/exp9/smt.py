...
def print_details(model):
    ...
    print("  BiasV1: [" + str(model[biasv1[0]].as_long()) + " ]")
    ...
    print("  BiasV2: [" + str(model[biasv2[0]].as_long()) + " ]")
...
def neuralNetwork(input, l1n1, l1n2, l2n1, l2n2, bias):
    ...
    hiddenValues[1] = (input[0] * l1n1[1]) + (input[1] * l1n2[1]) + 13
