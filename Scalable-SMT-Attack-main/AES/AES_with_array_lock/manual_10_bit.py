...
<<<<<<< HEAD
    ...
    # print("------------")
=======
>>>>>>> e644af58dbb1339e6f81302b4a9c087306cd389f
...
>>>>>>> b1a66628b3f59da32dc4f2e54f8c7281497bdbf9
...
#----------------------------------AddroundKey-----------------------------------------------------------------
    ...
    S = Store(S, 0 , S[0]^BitVecVal(208,10))
    S = Store(S, 1 , S[1]^BitVecVal(20,10))
    S = Store(S, 2 , S[2]^BitVecVal(249,10))
    S = Store(S, 3 , S[3]^BitVecVal(168,10))

    S = Store(S, 4 , S[4]^BitVecVal(201,10))
    S = Store(S, 5 , S[5]^BitVecVal(238,10))
    S = Store(S, 6 , S[6]^BitVecVal(37,10))
    S = Store(S, 7 , S[7]^BitVecVal(137,10))

    S = Store(S, 8 , S[8]^BitVecVal(225,10))
    S = Store(S, 9 , S[9]^BitVecVal(63,10))
    S = Store(S, 10 , S[10]^BitVecVal(12,10))
    S = Store(S, 11 , S[11]^BitVecVal(200,10))

    S = Store(S, 12 , S[12]^BitVecVal(182,10))
    S = Store(S, 13 , S[13]^BitVecVal(99,10))
    S = Store(S, 14 , S[14]^BitVecVal(12,10))
    S = Store(S, 15 , S[15]^BitVecVal(166,10))
...
<<<<<<< HEAD
m = solve(findOutput1(key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,key10_1)==oa)
print(m[key1_1])
print(m[key2_1])
print(m[key3_1])
print(m[key4_1])
