...
def findOutput1(key1,key2,key3,key4,key5,key6,key7,key8,key9,key10):
    ...
    # statemt = [255,255,255,255,255,255,255,255,25,65,34,54,98,90,90,123]

    S = Store(S,BitVecVal(0,10),BitVecVal(statemt[0],10))
    S = Store(S,BitVecVal(1,10),BitVecVal(statemt[1],10))
    S = Store(S,BitVecVal(2,10),BitVecVal(statemt[2],10))
    S = Store(S,BitVecVal(3,10),BitVecVal(statemt[3],10))
    S = Store(S,BitVecVal(4,10),BitVecVal(statemt[4],10))
    S = Store(S,BitVecVal(5,10),BitVecVal(statemt[5],10))
    S = Store(S,BitVecVal(6,10),BitVecVal(statemt[6],10))
    S = Store(S,BitVecVal(7,10),BitVecVal(statemt[7],10))
    S = Store(S,BitVecVal(8,10),BitVecVal(statemt[8],10))
    S = Store(S,BitVecVal(9,10),BitVecVal(statemt[9],10))
    S = Store(S,BitVecVal(10,10),BitVecVal(statemt[10],10))
    S = Store(S,BitVecVal(11,10),BitVecVal(statemt[11],10))
    S = Store(S,BitVecVal(12,10),BitVecVal(statemt[12],10))
    S = Store(S,BitVecVal(13,10),BitVecVal(statemt[13],10))
    S = Store(S,BitVecVal(14,10),BitVecVal(statemt[14],10))
    S = Store(S,BitVecVal(15,10),BitVecVal(statemt[15],10))
...
# s.add(simplify(sub(50,45,5,6,23,90,123,6,20,69,12,54,89,45,78,90,5,1,15,283,3) == oa))
# s.add(simplify(sub(50,45,5,1,23,90,123,6,20,69,12,54,89,45,78,90,5,1,15,283,3) == oa))
