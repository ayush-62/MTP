...
def sub(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,key1,key2,key3,key4,key5):
    ...
    I = Array('I', BitVecSort(32), BitVecSort(32))
    ...
    i = 0
    for arr in Sbox:
        I = Store(I, BitVecVal(i, 32), BitVecVal(arr,32))
        i += 1
    ...
    temp = I[s9_1*16 + s9_1b] 
    S = Store(S, BitVecVal(1, 32),I[s9_5*16 + s9_5b]) #key1=5
    S = Store(S, BitVecVal(5, 32),I[s9_9*16 + s9_9b])
    S = Store(S, BitVecVal(9, 32),I[s9_13*16 +s9_13b])
    S = Store(S, BitVecVal(13, 32),temp)

    temp = I[s9_2*16 + s9_2b]
    S = Store(S, BitVecVal(2, 32), I[s9_10*16 + s9_10b]) #key2=10
    S = Store(S, BitVecVal(10, 32), temp)
    temp = I[s9_6*16 + s9_6b] 
    S = Store(S, BitVecVal(6, 32), I[s9_14*16 + s9_14b])
    S = Store(S, BitVecVal(14, 32),temp)

    temp = I[s9_3*16 + s9_3b]
    S = Store(S, BitVecVal(3, 32), I[s9_15*16 + s9_15b]) #key3=15
    S = Store(S, BitVecVal(15, 32), I[s9_11*16 + s9_11b])
    S = Store(S, BitVecVal(11, 32), I[s9_7*16 + s9_7b]) 
    S = Store(S, BitVecVal(7, 32), temp)

    S = Store(S, BitVecVal(0, 32), I[s9_0*16 + s9_0b])
    S = Store(S, BitVecVal(4, 32), I[s9_4*16 + s9_4b])
    S = Store(S, BitVecVal(8, 32), I[s9_8*16 + s9_8b]) 
    S = Store(S, BitVecVal(12, 32),I[s9_12*16 + s9_12b])
