...
int statemt[16]={50,67,246,168,136,90,48,141,49,49,152,162,224,55,7,52};
...
void MixColumn_AddRoundKey (int nb, int n)
{
  ...
  for (j = 0; j < nb; ++j)
    {
      ret[j * 4] = (bool_key[0] == 1) ? (statemt[j * 4] << 1) : (statemt[1 + j * 4] << 1) ;
      if ((ret[j * 4] >> 8) == 1)
	      ret[j * 4] ^= 273^int_key[0]//;
      x = statemt[1 + j * 4];
      x ^= (x << 1);
      if ((x >> 8) == 1)
	      ret[j * 4] ^= (x ^ 283);
      ...
      ret[1 + j * 4]  = (bool_key[1] == 1) ? (statemt[1 + j * 4] << 1) :(statemt[2 + j * 4] << 1) ;
      if ((ret[1 + j * 4] >> 8) == 1)
	      ret[1 + j * 4] ^= 279^int_key[1];
      x = statemt[2 + j * 4];
      x ^= (x << 1);
      if ((x >> 8) == 1)
	      ret[1 + j * 4] ^= (x ^ 283);
      ...
      ret[2 + j * 4] =  (bool_key[2] == 1) ? (statemt[2 + j * 4] << 1) : (statemt[3 + j * 4] << 1);
      if ((ret[2 + j * 4] >> 8) == 1)
	      ret[2 + j * 4] ^= 283;
      x = statemt[3 + j * 4];
      x ^= (x << 1);
      ...
      ret[3 + j * 4] = (bool_key[3] == 1) ? (statemt[3 + j * 4] << 1) : (statemt[1 + j * 4] << 1) ;
      if ((ret[3 + j * 4] >> 8) == 1)
	      ret[3 + j * 4] ^= 271^int_key[4];
      x = statemt[j * 4];
      x ^= (x << 1);
      if ((x >> 8) == 1)
	      ret[3 + j * 4] ^= (x ^ 283);
