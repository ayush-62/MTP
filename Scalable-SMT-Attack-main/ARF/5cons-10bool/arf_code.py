...
#function definition 
def findOutput(i1,key1,key2,key3,key4,key5,k1,k2,k3,k4,k5,k6,k7,k8,k9,k10):
    ...
    op14 = If(Xor(op13==op14,k10), op14, op13 * BitVecVal(11,32))
    op18 = op14 * BitVecVal(13,32)
    op19 = op15 * op16
    op20 = op17 + op18
    op21 = BitVecVal(11,32) * op20
...
print(gg.check(findOutput(1,23,11,7,17,13,True,False,True,False,True,False,True,False,True,False)==oa))
...
s.add(simplify(findOutput(i1,key1_1,key2_1,key3_1,key4_1,key5_1,k1_1,k2_1,k3_1,k4_1,k5_1,k6_1,k7_1,k8_1,k9_1,k10_1) == out1))
s.add(simplify(findOutput(i1,key1_2,key2_2,key3_2,key4_2,key5_2,k1_2,k2_2,k3_2,k4_2,k5_2,k6_2,k7_2,k8_2,k9_2,k10_2) == out2))
s.add(i1>=0,i1<=255)
'''s.add(i2>=0,i2<=255)
s.add(i3>=0,i3<=255)
s.add(i4>=0,i4<=255)
...
while s.check(out1 != out2, Or(key1_1 != key1_2,key2_1 != key2_2,key3_1 != key3_2,key4_1 != key4_2,key5_1 != key5_2,k1_1!=k1_2,k2_1!=k2_2,k3_1!=k3_2,k4_1!=k4_2,k5_1!=k5_2,k6_1!=k6_2,k7_1!=k7_2,k8_1!=k8_2,k9_1!=k9_2,k10_1!=k10_2)) == sat:
    ...
    s.add(simplify(findOutput(m[i1],key1_1,key2_1,key3_1,key4_1,key5_1,k1_1,k2_1,k3_1,k4_1,k5_1,k6_1,k7_1,k8_1,k9_1,k10_1) == oa))
    s.add(simplify(findOutput(m[i1],key1_2,key2_2,key3_2,key4_2,key5_2,k1_2,k2_2,k3_2,k4_2,k5_2,k6_2,k7_2,k8_2,k9_2,k10_2) == oa))
    s.S
    print(s.non_units())
    j = j + 1
