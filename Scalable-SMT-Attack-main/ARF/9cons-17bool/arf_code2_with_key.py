...
key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1 = BitVecs('key1_1 key2_1 key3_1 key4_1 key5_1 key6_1 key7_1 key8_1 key9_1',32)
key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2 = BitVecs('key1_2 key2_2 key3_2 key4_2 key5_2 key6_2 key7_2 key8_2 key9_2',32)
...
#function definition 
def findOutput(G1,key1,key2,key3,key4,key5,key6,key7,key8,key9,k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12,k13,k14,k15,k16,k17):
    ...
    op14 = If(Xor(op13==op14,k12), op14, op13 * G1)
    op18 = If(k13,op14 * BitVecVal(13,32),BitVecVal(0,32)) #k13=True
    op19 = op15 * op16
    op20 = op17 + op18
    op21 = If(k14,BitVecVal(0,32),G1 * op20) #k14=False
    op22 = op19 * BitVecVal(13,32)
    op23 = op19 * G1
    op24 = op20 * (BitVecVal(13,32) + key9) #key9=12
...
print(gg.check(findOutput(11,23,11,7,17,13,8,31,14,12,True,False,True,False,True,False,True,False,True,False,True,False,True,False,True,False,True)==oa))
...
s.add(findOutput(G1,key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,k1_1,k2_1,k3_1,k4_1,k5_1,k6_1,k7_1,k8_1,k9_1,k10_1,k11_1,k12_1,k13_1,k14_1,k15_1,k16_1,k17_1) == out1)
s.add(findOutput(G1,key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2,k1_2,k2_2,k3_2,k4_2,k5_2,k6_2,k7_2,k8_2,k9_2,k10_2,k11_2,k12_2,k13_2,k14_2,k15_2,k16_2,k17_2) == out2)
s.add(G1>=0,G1<=255)
'''s.add(i2>=0,i2<=255)
s.add(i3>=0,i3<=255)
s.add(i4>=0,i4<=255)
...
s.add(k11_1==True,k11_2==True)
s.add(k12_1==False,k12_2==False)
s.add(k13_1==True,k13_2==True)
s.add(k14_1==False,k14_2==False)
s.add(k15_1==True,k15_2==True)
s.add(k16_1==False,k16_2==False)
s.add(k17_1==True,k17_2==True)


pos_set = set()
print("loop1 enter")
while s.check(out1 != out2, Or(key1_1 != key1_2,key2_1 != key2_2,key3_1 != key3_2,key4_1 != key4_2,key5_1 != key5_2,key6_1 != key6_2,key7_1 != key7_2,key8_1 != key8_2,key9_1 != key9_2,k1_1!=k1_2,k2_1!=k2_2,k3_1!=k3_2,k4_1!=k4_2,k5_1!=k5_2,k6_1!=k6_2,k7_1!=k7_2,k8_1!=k8_2,k9_1!=k9_2,k10_1!=k10_2,k11_1!=k11_2,k12_1!=k12_2,k13_1!=k13_2,k14_1!=k14_2,k15_1!=k15_2,k16_1!=k16_2,k17_1!=k17_2)) == sat:
    ...
    s.add(findOutput(m[G1],key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,k1_1,k2_1,k3_1,k4_1,k5_1,k6_1,k7_1,k8_1,k9_1,k10_1,k11_1,k12_1,k13_1,k14_1,k15_1,k16_1,k17_1) == oa)
    s.add(findOutput(m[G1],key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2,k1_2,k2_2,k3_2,k4_2,k5_2,k6_2,k7_2,k8_2,k9_2,k10_2,k11_2,k12_2,k13_2,k14_2,k15_2,k16_2,k17_2) == oa)
    j = j + 1
