...
#function definition 
def findOutput(i1,key1,key2,key3,key4,key5,key6,key7,key8,key9,k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12,k13,k14,k15,k16,k17):

    op1 = BitVecVal(17,32) * (i1 + key1) #key1=23
    op2 = If(k1,BitVecVal(19,32) * BitVecVal(2,32),BitVecVal(0,32)) # k1=True
    op3 = BitVecVal(11,32) * BitVecVal(2,32)
    op4 = If(k2,BitVecVal(0,32),BitVecVal(13,32) * i1) #k2=False
    op5 = If(Not(Xor(BitVecVal(11,32)>10,k3)), BitVecVal(11,32) * BitVecVal(3,32), BitVecVal(0,32)) # k3=True
    op5 = If(Not(Xor(BitVecVal(11,32)>10,k3)), op5 + (BitVecVal(17,32) * key2), op5) #key2=11
...
print(gg.check(findOutput(1,23,11,7,17,13,8,31,14,12,True,False,True,False,True,False,True,False,True,False,True,False,True,False,True,False,True)==oa))
...
s.add(findOutput(i1,key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,k1_1,k2_1,k3_1,k4_1,k5_1,k6_1,k7_1,k8_1,k9_1,k10_1,k11_1,k12_1,k13_1,k14_1,k15_1,k16_1,k17_1) == out1)
s.add(findOutput(i1,key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2,k1_2,k2_2,k3_2,k4_2,k5_2,k6_2,k7_2,k8_2,k9_2,k10_2,k11_2,k12_2,k13_2,k14_2,k15_2,k16_2,k17_2) == out2)
s.add(i1>=0,i1<=255)
'''s.add(i2>=0,i2<=255)
s.add(i3>=0,i3<=255)
s.add(i4>=0,i4<=255)
...
while s.check(out1 != out2, Or(key1_1 != key1_2,key2_1 != key2_2,key3_1 != key3_2,key4_1 != key4_2,key5_1 != key5_2,key6_1 != key6_2,key7_1 != key7_2,key8_1 != key8_2,key9_1 != key9_2,k1_1!=k1_2,k2_1!=k2_2,k3_1!=k3_2,k4_1!=k4_2,k5_1!=k5_2,k6_1!=k6_2,k7_1!=k7_2,k8_1!=k8_2,k9_1!=k9_2,k10_1!=k10_2,k11_1!=k11_2,k12_1!=k12_2,k13_1!=k13_2,k14_1!=k14_2,k15_1!=k15_2,k16_1!=k16_2,k17_1!=k17_2)) == sat:
    ...
    #print(m)
    print("DIP")
    print(str(m[i1]))#+" "+str(m[i2])+" "+str(m[i3])+" "+str(m[i4])+" "+str(m[i6])+" "+str(m[G1])+" "+str(m[G2])+" "+str(m[GG1])+" "+str(m[GG2]))
    print("The key is:")
    ...
    ia = str(m[i1]) + " " + str(2) + " " + str(3) + " " + str(5) + " " + str(7) + " " + str(11) + " " + str(13) + " " + str(17) + " " + str(19)
    #using the input to get the correct output for the DIP from the oracle 
    [oa1,oa2,oa3,oa4] = Cexec(ia)
    oa = tuple.tuple(BitVecVal(oa1,32),BitVecVal(oa2,32),BitVecVal(oa3,32),BitVecVal(oa4,32))
    #constraints added with the DIP
    s.add(findOutput(m[i1],key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,k1_1,k2_1,k3_1,k4_1,k5_1,k6_1,k7_1,k8_1,k9_1,k10_1,k11_1,k12_1,k13_1,k14_1,k15_1,k16_1,k17_1) == oa)
    s.add(findOutput(m[i1],key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2,k1_2,k2_2,k3_2,k4_2,k5_2,k6_2,k7_2,k8_2,k9_2,k10_2,k11_2,k12_2,k13_2,k14_2,k15_2,k16_2,k17_2) == oa)
    j = j + 1
