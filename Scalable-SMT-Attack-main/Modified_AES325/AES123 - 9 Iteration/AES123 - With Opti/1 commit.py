...
# --------------------------------Iteration 0 ----------------------------------------------------------------------------------
    ...
    S = Store(S, BitVecVal(1, 32), If(nb==4,  I[S[key1] >> 4][S[5] & 0xf], S[1])) #key1=5
    ...
    S = Store(S, BitVecVal(2, 32), If(nb==4,  I[S[key2] >> 4][S[10] & 0xf], S[2])) #key2=10
    ...
    S = Store(S, BitVecVal(3, 32), If(nb==4,  I[S[key3] >> 4][S[15] & 0xf], S[3])) #key3=15
    ...
    ret = Store(ret, key2 + j * 4, If(j < nb, S[3 + j * 4] << 1, ret[3 + j * 4])) #key2 3
    ...
    x = S[2 + j * key4] #key4 4
    x = x ^ (x << 1)
    ret = Store(ret, 1 + j * 4, If(And(j < nb, x >> 8 == 1), ret[1 + j * 4] ^ (x ^ 283), ret[1 + j * 4])) #key4 4
    ret = Store(ret, 1 + j * 4, If(And(j < nb, Not(x >> 8 == 1)), ret[1 + j * 4] ^ x, ret[1 + j * 4]))
    ret = Store(ret, 1 + j * 4, If(j < nb, ret[1 + j * 4] ^ (S[3 + j * 4] ^ S[j * 4] ^ W[1][j + nb * n]), ret[1 + j * 4]))
...
def sub(key1,key2,nb,n):
    ...
    S = Store(S, j * 4 , S[j * 4]^W[0][nb * n])
    S = Store(S, 1 + j * 4 ,S[1 + j * 4]^W[1][nb * n])
    S = Store(S, 2 + j * 4 ,S[2 + j * 4]^W[2][nb * n])
    S = Store(S, 3 + j * 4 ,S[3 + j * 4]^W[3][nb * n])
    ...
    x = S[3 + j * 4]
    x = x ^ (x << 1)
    ret = Store(ret, 2 + j * 4, If(And(j < nb, x >> 8 == 1), ret[2 + j * 4] ^ (x ^ key1), ret[2 + j * 4])) #key1 283
    ret = Store(ret, 2 + j * 4, If(And(j < nb, Not(x >> 8 == 1)), ret[2 + j * 4] ^ x, ret[2 + j * 4]))
    ret = Store(ret, 2 + j * 4, If(j < nb, ret[2 + j * 4] ^ (S[j * 4] ^ S[1 + j * 4] ^ W[2][j + nb * n]), ret[2 + j * 4]))
...
print(gg.check(findOutput(283,3,1,4,3,8,2,1,2,3,4,0)==oa))
...
key9=2 ==>3
key10=3==>3'''
s.add(key2_1>=0,key2_1<=3)
s.add(key2_2>=0,key2_2<=3)
s.add(key3_1>=0,key3_1<=27)
s.add(key3_2>=0,key3_2<=27)
s.add(key4_1>=0,key4_1<=30)
s.add(key4_2>=0,key4_2<=30)
s.add(key5_1>=0,key5_1<=27)
s.add(key5_2>=0,key5_2<=27)
s.add(key6_1>=0,key6_1<=30)
s.add(key6_2>=0,key6_2<=30)
s.add(key7_1>=0,key7_1<=23)
s.add(key7_2>=0,key7_2<=23)
s.add(key8_1>=0,key8_1<=14)
s.add(key8_2>=0,key8_2<=14)
s.add(key9_1>=0,key9_1<=3)
s.add(key9_2>=0,key9_2<=3)
s.add(key10_1>=0,key10_1<=3)
s.add(key10_2>=0,key10_2<=3)
