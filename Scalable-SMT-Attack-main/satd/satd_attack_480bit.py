...
key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,key10_1,key11_1,key12_1,key13_1,key14_1,key15_1 = Ints('key1_1 key2_1 key3_1 key4_1 key5_1 key6_1 key7_1 key8_1 key9_1 key10_1 key11_1 key12_1 key13_1 key14_1 key15_1')
key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2,key10_2,key11_2,key12_2,key13_2,key14_2,key15_2 = Ints('key1_2 key2_2 key3_2 key4_2 key5_2 key6_2 key7_2 key8_2 key9_2 key10_2 key11_2 key12_2 key13_2 key14_2 key15_2')

def satd(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17,i18,i19,i20,i21,i22,i23,i24,i25,i26,i27,i28,i29,i30,i31,i32,key1,key2,key3,key4,key5,key6,key7,key8,key9,key10,key11,key12,key13,key14,key15):
    ...
    t1 = Store(t1, 1, Select(pix, key8) - Select(pix, 17))      # key8 = 1
    t1 = Store(t1, 2, Select(pix, key9) - Select(pix, 18))      # key9 = 2
    t1 = Store(t1, 3, Select(pix, key10) - Select(pix, 19))     # key10 = 3

    t2 = Array('t2', IntSort(), IntSort())
    t2 = Store(t2, 0, Select(pix, key11) - Select(pix, 20))     # key11 = 4
    t2 = Store(t2, 1, Select(pix, key12) - Select(pix, key2))   # key12 = 5, key2 = 21
    t2 = Store(t2, 2, Select(pix, key13) - Select(pix, 22))     # key13 = 6
    t2 = Store(t2, 3, Select(pix, key14) - Select(pix, 23))     # key14 = 7

    t3 = Array('t3', IntSort(), IntSort())
    t3 = Store(t3, 0, Select(pix, 8)  - Select(pix, key15))     # key15 = 24
...
#key1 = 16, key2 = 5, key3 = 10, key4 = 14, key5 = 5, key6 = 3, key7 = 2, key 8 = 1, key9 = 2, key10 = 3, key11 = 4, key12 = 5, key13 = 6, key14 = 7, key15 = 24
# print(simplify(satd(0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,2,0,1,16,21,10,14,5,3,2,1,2,3,4,5,6,7,24)))
# exit()
...
s.add(satd(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17,i18,i19,i20,i21,i22,i23,i24,i25,i26,i27,i28,i29,i30,i31,i32,key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,key10_1,key11_1,key12_1,key13_1,key14_1,key15_1) == out_1)
s.add(satd(i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17,i18,i19,i20,i21,i22,i23,i24,i25,i26,i27,i28,i29,i30,i31,i32,key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2,key10_2,key11_2,key12_2,key13_2,key14_2,key15_2) == out_2)

while s.check(out_1 != out_2, Or(key1_1 != key1_2,key2_1 != key2_2,key3_1 != key3_2,key4_1 != key4_2,key5_1 != key5_2, key6_1 != key6_2, key7_1 != key7_2, key8_1 != key8_2,key9_1 != key9_2,key10_1 != key10_2,key11_1 != key11_2,key12_1 != key12_2, key13_1 != key13_2, key14_1 != key14_2, key15_1 != key15_2)) == sat:
    ...
    out = Int('out')
    out = IntVal(oa)
    s.add(simplify(satd(m[i1],m[i2],m[i3],m[i4],m[i5],m[i6],m[i7],m[i8],m[i9],m[i10],m[i11],m[i12],m[i13],m[i14],m[i15],m[i16],m[i17],m[i18],m[i19],m[i20],m[i21],m[i22],m[i23],m[i24],m[i25],m[i26],m[i27],m[i28],m[i29],m[i30],m[i31],m[i32],key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,key10_1,key11_1,key12_1,key13_1,key14_1,key15_1) == oa))
    s.add(simplify(satd(m[i1],m[i2],m[i3],m[i4],m[i5],m[i6],m[i7],m[i8],m[i9],m[i10],m[i11],m[i12],m[i13],m[i14],m[i15],m[i16],m[i17],m[i18],m[i19],m[i20],m[i21],m[i22],m[i23],m[i24],m[i25],m[i26],m[i27],m[i28],m[i29],m[i30],m[i31],m[i32],key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2,key10_2,key11_2,key12_2,key13_2,key14_2,key15_2) == oa))
...
t = PrettyTable(['key1','key2','key3','key4','key5','key6','key7', 'key8', 'key9', 'key10','key11','key12','key13','key14','key15'])
pos_set = set()
TO_init = 1600
TO_max = 12800
rem_key_max = 32
...
while s.check(key1_1 == key1_2,key2_1 == key2_2,key3_1 == key3_2,key4_1 == key4_2,key5_1 == key5_2,key6_1 == key6_2,key7_1 == key7_2,key8_1 == key8_2,key9_1 == key9_2,key10_1 == key10_2,key11_1 == key12_2,key13_1 == key13_2,key14_1 == key14_2,key15_1 == key15_2) != unsat:
    try:
        m = s.model()
    except:
        break_away = True
    ...
    pos_set.add(m)
    t.add_row([str(m[key1_1]),str(m[key2_1]),str(m[key3_1]),str(m[key4_1]),str(m[key5_1]),str(m[key6_1]),str(m[key7_1]),str(m[key8_1]),str(m[key9_1]),str(m[key10_1]),str(m[key11_1]),str(m[key12_1]),str(m[key13_1]),str(m[key14_1]),str(m[key15_1])])
    # print(str(m[key1_1])+" "+str(m[key2_1])+" "+str(m[key3_1])+" "+str(m[key4_1])+" "+str(m[key5_1])+" "+str(m[k1_1])+" "+str(m[k2_1])+" "+str(m[k3_1])+" "+str(m[k4_1])+" "+str(m[k5_1])+" "+str(m[k6_1])+" "+str(m[k7_1])+" "+str(m[k8_1])+" "+str(m[k9_1])+" "+str(m[k10_1]))
    ...
    s.add(Or(key1_1 != m[key1_1],key2_1!=m[key2_1],key3_1!=m[key3_1],key4_1!=m[key4_1],key5_1!=m[key5_1],key6_1!=m[key6_1],key7_1!=m[key7_1],key8_1 != m[key8_1],key9_1!=m[key9_1],key10_1!=m[key10_1],key11_1!=m[key11_1],key12_1!=m[key12_1],key13_1!=m[key13_1],key14_1!=m[key14_1],key15_1!=m[key15_1]))
    s.add(Or(key1_2 != m[key1_2],key2_2!=m[key2_2],key3_2!=m[key3_2],key4_2!=m[key4_2],key5_2!=m[key5_2],key6_2!=m[key6_2],key7_2!=m[key7_2],key8_2 != m[key8_2],key9_2!=m[key9_2],key10_2!=m[key10_2],key11_2!=m[key11_2],key12_2!=m[key12_2],key13_2!=m[key13_2],key14_2!=m[key14_2],key15_2!=m[key15_2]))
    # p = p + 1
