...
g.add(simplify(findOutput(key1_1,key2_1,key3_1,key4_1,nb,n)) == out1)
g.add(simplify(findOutput(key1_2,key2_2,key3_2,key4_2,nb,n)) == out2)
g.add(nb==4)
g.add(n>=0 ,n<15)
...
while len(pos_l) > 1:
    ...
    g.push()
    g.add(key1_2==m2[key1_2],key2_2==m2[key2_2],key3_2==m2[key3_2],key4_2==m2[key4_2])
    g.add(key1_1==m1[key1_2],key2_1==m1[key2_2],key3_1==m1[key3_2],key4_1==m1[key4_2])
    if g.check(out1 != out2) == sat:
        ...
        if g.check(simplify(findOutput(m1[key1_2],m1[key2_2],m1[key3_2],m1[key4_2],m[nb],m[n])) == oa) == unsat:
            pos_l.remove(m1)
        if g.check(simplify(findOutput(m2[key1_2],m2[key2_2],m2[key3_2],m2[key4_2],m[nb],m[n])) == oa) == unsat:
            pos_l.remove(m2)
    else:
        pos_l.remove(m1)
    g.pop()
