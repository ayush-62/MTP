...
#function definition 
def findOutput(in4,key1,key2,key3,key4,key5,key6,key7,key8,key9,key10,k1,k2,k3,k4,k5):
    mult1 = BitVecVal(1,32) * BitVecVal(2,32)
    mult2 = BitVecVal(1,32) * (BitVecVal(3,32) + key1) #key1=3
    mult3 = BitVecVal(3,32) * BitVecVal(13,32)
    mult4 = (in4+key2) * BitVecVal(7,32) #key2=5
    mult5 = BitVecVal(3,32) * BitVecVal(2,32)
    mult6 = BitVecVal(2,32) * (BitVecVal(7,32) + key3) #key3=7
    mult7 = BitVecVal(3,32) * BitVecVal(11,32)
    mult8 = (in4 + key4) * BitVecVal(13,32) #key4=11
    mult9 = in4 * BitVecVal(17,32)
...
def sub(in4,key1,key2):
    mult1 = BitVecVal(1,32) * BitVecVal(2,32)
    mult2 = BitVecVal(1,32) * (BitVecVal(3,32) + key1) #key1=3
    mult3 = BitVecVal(3,32) * BitVecVal(13,32)
    mult4 = (in4+key2) * BitVecVal(7,32) #key2=5

    o=tuple.tuple2(mult1+mult2+mult3+mult4)
    return o
...
s.add(sub(in4,key1_1,key2_1)==out3)
s.add(sub(in4,key1_2,key2_2)==out4)
...
while s.check(out3 != out4, Or(key1_1 != key1_2,key2_1 != key2_2,key3_1 != key3_2,key4_1 != key4_2,key5_1 != key5_2,key6_1 != key6_2,key7_1 != key7_2,key8_1 != key8_2,key9_1 != key9_2,key10_1!=key10_2,k1_1!=k1_2,k2_1!=k2_2,k3_1!=k3_2,k4_1!=k4_2,k5_1!=k5_2)) == sat:
    ...
    #print(m)
    print("DIP")
    print(str(m[in4]))#+" "+str(m[in2])+" "+str(m[in3])+" "+str(m[in4])+" "+str(m[in5])+" "+str(m[in6])+" "+str(m[in7])+" "+str(m[in8])+" "+str(m[in9])+" "+str(m[in10]))
    print("The key is:")
    ...
    ia = str(1)+" "+str(2)+" "+str(3)+" "+str(m[in4])+" "+str(7)+" "+str(11)+" "+str(13)+" "+str(17)+" "+str(19)+" "+str(23)
    #using the input to get the correct output for the DIP from the oracle 
    [oa1,oa2,oa3] = Cexec(ia)
    oa = tuple.tuple1(BitVecVal(oa1,32),BitVecVal(oa2,32),BitVecVal(oa3,32))
    #constraints added with the DIP
    s.add(findOutput(m[in4],key1_1,key2_1,key3_1,key4_1,key5_1,key6_1,key7_1,key8_1,key9_1,key10_1,k1_1,k2_1,k3_1,k4_1,k5_1) == oa)
    s.add(findOutput(m[in4],key1_2,key2_2,key3_2,key4_2,key5_2,key6_2,key7_2,key8_2,key9_2,key10_2,k1_2,k2_2,k3_2,k4_2,k5_2) == oa)
    j = j + 1
