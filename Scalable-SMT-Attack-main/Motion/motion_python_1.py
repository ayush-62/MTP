...
#function definition 
def findOutput(in1,in2,in3,in4,in5,in6,in7,in8,in9,in10,key2,key4,key6,key7,key9):
    mult1 = in1 * in2
    mult2 = in1 * (in3 + BitVecVal(3,32)) 
    mult3 = in3 * in7
    mult4 = (in4+key2) * in5 #key2=5
    mult5 = in3 * in2
    mult6 = in2 * (in5 + BitVecVal(7,32))
    mult7 = in3 * in6
    mult8 = (in4 + key4) * in7 #key4=11
    mult9 = in4 * in8
    mult10 = in6 * (in9 + BitVecVal(13,32))
    mult11 = in6 * in8
    ...
    add6 = mult1 + (add1 * BitVecVal(11,32))
    out1 = add6
...
def sub(in1,in2,in3,in4,in5,in6,in7,in8,in9,in10,key2,key4,key6,key7):
    mult1 = in1 * in2
    mult2 = in1 * (in3 + BitVecVal(3,32)) 
    mult3 = in3 * in7
    mult4 = (in4+key2) * in5 #key2=5
    ...
    o=tuple.tuple2(mult1+mult2+mult3+mult4+mult5+mult6+mult7+mult8+mult9+mult10+mult11+mult12+mult13+mult14)
    return o
...
print(gg.check(findOutput(1,2,3,5,7,11,13,17,19,23,5,11,17,19,2)==oa))


#SMT solver declaration 
s = Tactic('smt').solver()

s.add(sub(in1,in2,in3,in4,in5,in6,in7,in8,in9,in10,key2_1,key4_1,key6_1,key7_1)==out3)
s.add(sub(in1,in2,in3,in4,in5,in6,in7,in8,in9,in10,key2_2,key4_2,key6_2,key7_2)==out4)
...
s.add(key2_1<=1000,key2_2<=1000)
s.add(key4_1<=1000,key4_2<=1000)
s.add(key6_1<=1000,key6_2<=1000)
...
while s.check(out3 != out4, Or(key2_1 != key2_2,key4_1 != key4_2,key6_1 != key6_2,key7_1 != key7_2,key9_1 != key9_2)) == sat:
    ...
    print("The key is:")
    print(str(m[key2_1])+" "+str(m[key4_1])+" "+str(m[key6_1])+" "+str(m[key7_1])+" "+str(m[key9_1]))
    print(str(m[key2_2])+" "+str(m[key4_2])+" "+str(m[key6_2])+" "+str(m[key7_2])+" "+str(m[key9_2]))
    ...
    s.add(findOutput(m[in1],m[in2],m[in3],m[in4],m[in5],m[in6],m[in7],m[in8],m[in9],m[in10],key2_1,key4_1,key6_1,key7_1,key9_1) == oa)
    s.add(findOutput(m[in1],m[in2],m[in3],m[in4],m[in5],m[in6],m[in7],m[in8],m[in9],m[in10],key2_2,key4_2,key6_2,key7_2,key9_2) == oa)
    j = j + 1
...
while s.check(key2_1 == key2_2,key4_1 == key4_2,key6_1 == key6_2,key7_1 == key7_2,key9_1 == key9_2) != unsat:
    try:
        m = s.model()
    except:
        break_away = True
    ...
    pos_set.add(m)
    print(str(m[key2_1].as_signed_long())+" "+str(m[key4_1].as_signed_long())+" "+str(m[key6_1].as_signed_long())+" "+str(m[key7_1].as_signed_long())+" "+str(m[key9_1].as_signed_long()))
    #If size crossed threshold exit
    if len(pos_set) > rem_key_max:
        break

    #adding constraints - K1 & K2 is not equal to current key fetched
    s.add(Or(key2_1!=m[key2_1],key4_1!=m[key4_1],key6_1!=m[key6_1],key7_1!=m[key7_1],key9_1!=m[key9_1]))
    s.add(Or(key2_2!=m[key2_2],key4_2!=m[key4_2],key6_2!=m[key6_2],key7_2!=m[key7_2],key9_2!=m[key9_2]))
    p = p + 1
