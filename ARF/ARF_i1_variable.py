...
s.add(GG1 == BitVecVal(17,32))
s.add(GG2 == BitVecVal(19,32))
...
t = PrettyTable(['key1','key2','key3','key4','key5','k1','k2','k3','k4','k5','k6','k7','k8','k9','k10'])
...
while s.check(out1 != out2, Or(key1_1 != key1_2,key2_1 != key2_2,key3_1 != key3_2,key4_1 != key4_2,key5_1 != key5_2,k1_1!=k1_2,k2_1!=k2_2,k3_1!=k3_2,k4_1!=k4_2,k5_1!=k5_2,k6_1!=k6_2,k7_1!=k7_2,k8_1!=k8_2,k9_1!=k9_2,k10_1!=k10_2)) == sat:
    ...
    s.add(simplify(findOutput(m[i1],m[i2],m[i3],m[i4],m[i6],m[G1],m[G2],m[GG1],m[GG2],key1_1,key2_1,key3_1,key4_1,key5_1,k1_1,k2_1,k3_1,k4_1,k5_1,k6_1,k7_1,k8_1,k9_1,k10_1) == oa))
    s.add(simplify(findOutput(m[i1],m[i2],m[i3],m[i4],m[i6],m[G1],m[G2],m[GG1],m[GG2],key1_2,key2_2,key3_2,key4_2,key5_2,k1_2,k2_2,k3_2,k4_2,k5_2,k6_2,k7_2,k8_2,k9_2,k10_2) == oa))
