...
def neuralNetwork(input, l1n1, l1n2, l1b):
    ...
    valw = round(q_w1/(2**(shift_w1+31)) , 3)
    updated_l1n1 = RealVector('updated_l1n1' , 3)
    
    updated_l1n1[0] = ((l1n1[0] - zp_w[0])*valw)
    updated_l1n1[1] = ((l1n1[1] - zp_w[0])*valw)
    updated_l1n1[2] = ((l1n1[2] - zp_w[0])*valw)

    updated_l1n2 = RealVector('updated_l1n2' , 3)
    updated_l1n2[0] = ((l1n2[0] - zp_w[0])*valw)
    updated_l1n2[1] = ((l1n2[1] - zp_w[0])*valw)
    updated_l1n2[2] = ((l1n2[2] - zp_w[0])*valw)

    updated_bias  =  RealVector('updated_bias' , 3)
    valb = round(q_b1/(2**(shift_b1+31)) , 3)
    updated_bias[0] = ((l1b[0]-zp_b[0])*valb)
    updated_bias[1] = ((l1b[1]-zp_b[0])*valb)
    updated_bias[2] = ((l1b[2]-zp_b[0])*valb)
...
print(simplify(neuralNetwork([255,1], [96 , 228 , 0], [62 , 254, 47] , [116 , 0 , 454])))
print(s.check(neuralNetwork([255,1], [96 , 228 , 0], [62 , 254, 47] , [116 , 0 , 454]) == out_tup))
