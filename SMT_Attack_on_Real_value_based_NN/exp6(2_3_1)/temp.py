...
def neuralNetwork(input, l1n1, l1n2, l1b):
    ...
    updated_bias[0] = ((q_b1*(l1b[0] - zp_b[0])))
    updated_bias[1] = ((q_b1*(l1b[1] - zp_b[0])))
    updated_bias[2] = ((q_b1*(l1b[2] - zp_b[0])))
...
print(s.check(neuralNetwork([67 , 56], [96 , 228 , 0] , [62 , 254 , 47] , [116 , 0 , 254]) == out_tup))
