...
in1,in2,in3,in4 = Reals('in1 in2 in3 in4')
...
def NN(in1,in2,in3,in4,l2n1_1,l2n1_2,l2n1_3,l2n1_4,l2n2_1,l2n2_2,l2n2_3,l2n2_4,l2n3_1,l2n3_2,l2n3_3,l2n3_4,l2n4_1,l2n4_2,l2n4_3,l2n4_4):
	...
	l3out_1 = (in1 * l2n1_1) + (in2 * l2n2_1) + (in3 * l2n3_1) + (in4 * l2n4_1) 
	l3out_1 = If(l3out_1 < 0, 0, l3out_1)
	l3out_2 = (in1 * l2n1_2) + (in2 * l2n2_2) + (in3 * l2n3_2) + (in4 * l2n4_2) 
	l3out_2 = If(l3out_2 < 0, 0, l3out_2)
	l3out_3 = (in1 * l2n1_3) + (in2 * l2n2_3) + (in3 * l2n3_3) + (in4 * l2n4_3) 
	l3out_3 = If(l3out_3 < 0, 0, l3out_3)
	l3out_4 = (in1 * l2n1_4) + (in2 * l2n2_4) + (in3 * l2n3_4) + (in4 * l2n4_4) 
...
s.add(NN(in1,in2,in3,in4,l2n1v1_1,l2n1v1_2,l2n1v1_3,l2n1v1_4,l2n2v1_1,l2n2v1_2,l2n2v1_3,l2n2v1_4,l2n3v1_1,l2n3v1_2,l2n3v1_3,l2n3v1_4,l2n4v1_1,l2n4v1_2,l2n4v1_3,l2n4v1_4) == out1)
s.add(NN(in1,in2,in3,in4,l2n1v2_1,l2n1v2_2,l2n1v2_3,l2n1v2_4,l2n2v2_1,l2n2v2_2,l2n2v2_3,l2n2v2_4,l2n3v2_1,l2n3v2_2,l2n3v2_3,l2n3v2_4,l2n4v2_1,l2n4v2_2,l2n4v2_3,l2n4v2_4) == out2)

while s.check(out1 != out2) == sat:
	m = s.model()
	ia = str(m[in1]) + " " + str(m[in2]) + " " + str(m[in3]) + "  " + str(m[in4]) + " " + str(time.time() - start_time)
	print(ia)
	out = Cexec(ia)
	print(out)
	inp1 = m[in1]
