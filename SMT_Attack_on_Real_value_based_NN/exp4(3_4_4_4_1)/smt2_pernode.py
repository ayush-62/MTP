...
def Cexec(init_string):
    out = subprocess.check_output("./oracle_pernode.out %s" % init_string, shell=True,)
...
l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1 = Reals('l2n1v1_1 l2n2v1_1 l2n3v1_1 l2n4v1_1')
l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1 = Reals('l2n1v2_1 l2n2v2_1 l2n3v2_1 l2n4v2_1')
out1 , out2 = Reals('out1 out2')
...
def NN(in1,in2,in3,l2n1_1,l2n2_1,l2n3_1,l2n4_1,):
...
# s.add(l2n4v2_4 <= -3.9+3 , l2n4v2_4 >= -3.9-3)

s.add(in1 !=0 , in2 != 0 , in3 !=0)
s.add(NN(in1,in2,in3,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1) == out1)
s.add(NN(in1,in2,in3,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1) == out2)
...
while s.check(out1 != out2) == sat:
	...
	s.add(NN(inp1,inp2,inp3,l2n1v1_1,l2n2v1_1,l2n3v1_1,l2n4v1_1) == out[0])
	s.add(NN(inp1,inp2,inp3,l2n1v2_1,l2n2v2_1,l2n3v2_1,l2n4v2_1) == out[0])
